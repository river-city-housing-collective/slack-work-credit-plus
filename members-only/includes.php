...
<script src="/members-only/slack.js"></script>
<link rel="stylesheet" href="/members-only/style.css">
...
<div id="loggedInDisplay" style="display: none">
    ...
    <div id="avatar">
        ...
        <ul id="userInfoDiv">
            <li style="font-size: 0.75vw">Logged in as:</li>
            <li id="username"></li>
            <li id="house" style="font-size: 1vw">Resident @ Summit</li>
        </ul>
